    ...
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            while (continuar)
            {
                ...
                Console.WriteLine("1. Diario Personal (Ejercicio 1)");
                Console.WriteLine("2. Gestor de Contactos CSV (Ejercicio 2)");
                Console.WriteLine("3. Creador de Estructura de Proyectos (Ejercicio 3)");
