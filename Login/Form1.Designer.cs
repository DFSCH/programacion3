namespace Login
{
    partial class Form1
    {
        ...
        private void InitializeComponent()
        {
            ...
            label2.Location = new Point(357, 34);
            label2.Name = "label2";
            label2.Size = new Size(243, 20);
            label2.TabIndex = 1;
            label2.Text = "CONFIRMAR CORREO ELETRONICO";
            // 
            // textBox1
            // 
            textBox1.Location = new Point(70, 71);
            ...
            label4.Location = new Point(357, 126);
            label4.Name = "label4";
            label4.Size = new Size(96, 20);
            label4.TabIndex = 5;
            label4.Text = "INCORRECTA";
